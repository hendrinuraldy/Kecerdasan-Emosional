...
.col-md-4 {
        ...
        <div class="col-md-4 mt-3">
            <a href="edukasiblog.php">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Mengenal Kecerdasan Emosional, Apa Cirinya?</h5>
                        <p class="card-text">apa saja ciri-ciri orang yang memiliki kecerdasan emosional?</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4 mt-3">
            <a href="edukasiblog2.php">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Kaitan Antara Membaca dan Kecerdasan Emosional</h5>
                        <p class="card-text"> Membaca dapat meningkatkan kecerdasan emosional.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4 mt-3">
            <a href="edukasiblog3.php">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Mengapa Kecerdasan Emosional Itu Penting?</h5>
                        <p class="card-text">EQ yang baik dapat menentukan keberhasilan individu dalam membangun kesuksesan karir.</p>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="row">
        <div class="col-md-4 mt-3">
            <a href="edukasiblog4.php">
                <div class="card shadow">
                    <img src="img/jamet4.png" class="card-img-top img-fluid" alt="Gambar 1">
                    <div class="card-body">
                        <h5 class="card-title">Bagaimana cara membedakan EQ tinggi, sedang, dan rendah?</h5>
                        <p class="card-text">Orang dengan kecerdasan emosional rendah seringkali bersikap kaku.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4 mt-3">
            <a href="edukasiblog5.php">
                <div class="card shadow">
                    <img src="img/jamet5.png" class="card-img-top img-fluid" alt="Gambar 2">
                    <div class="card-body">
                        <h5 class="card-title">Aktivitas Fisik Meningkatkan EQ</h5>
                        <p class="card-text">Setelah melakukan aktivitas fisik, mereka seperti merasakan energi positif.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4 mt-3">
            <a href="edukasiblog6.php">
                <div class="card shadow">
                    <img src="img/jamet6.png" class="card-img-top img-fluid" alt="Gambar 3">
                    <div class="card-body">
                        <h5 class="card-title">Dampak dari Menyembunyikan Emosi</h5>
                        <p class="card-text">Selain berdampak pada kehidupan sosial, dapat juga mengganggu kesehatan psikolog..</p>
                    </div>
                </div>
            </a>
        </div>
