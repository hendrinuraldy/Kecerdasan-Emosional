...
<div class="container-xxl position-relative p-0">
              ...
              <a href="index.html" class="navbar-brand p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="welcome.php" class="nav-item nav-link">Home</a>
                        ...
                        <a href="testemosional.php" class="nav-item nav-link active">Test Kecerdasan</a>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h2 class="text-start">Tes Kecerdasan Emosi</h2>
...
Emoti Space akan mengajakmu untuk lebih dalam mengenali kecerdasan emosimu. Cari tahu berbagai tips agar lebih mampu mengelola emosi, sehingga memperbesar peluang kamu untuk meraih kesuksesan. Mengenali diri sendiri adalah langkah awal untuk berprestasi. Ayo mulai!</p>
            ...
            <a  href="Test.html" class="btn btn-primary text-center">Mulai Test</a>
            <p class="mt-3 text-center"><a href="#">Baca Panduan Pengisian Kuis</a></p>
